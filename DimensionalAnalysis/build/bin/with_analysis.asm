...
with_analysis:     file format elf64-x86-64
...
0000000000000358 <.note.gnu.build-id>:
 ...
 367:	00 51 6c             	add    %dl,0x6c(%rcx)
 36a:	ab                   	stos   %eax,%es:(%rdi)
 36b:	f4                   	hlt    
 36c:	f4                   	hlt    
 36d:	4c                   	rex.WR
 36e:	64 c1 c3 81          	fs rol $0x81,%ebx
 372:	25 b9 50 cb 93       	and    $0x93cb50b9,%eax
 377:	0c a1                	or     $0xa1,%al
 379:	c6                   	(bad)  
 37a:	d2                   	.byte 0xd2
 37b:	78                   	.byte 0x78
